...
if __name__=="__main__":
    ...
    iosSDK_IncTo = os.path.join('', '../../VsboardMobile/include/ios/deviceapis/models')
    iosSDK_SrcTo = os.path.join('', '../../VsboardMobile/iOS/deviceapis/models')
    ...
    modelSDK_IncTo = os.path.join('', '../../VsboardMobile/include/deviceapis/models')
    modelSDK_SrcTo = os.path.join('', '../../VsboardMobile/deviceapis/models')
